...
public class SchemaInfoImpl<T extends PersistentData> extends SchemaInfo<T> {
    ...
    public SchemaColumn addColumn(String fieldName, Class<?> fieldClass, 
            ...
            boolean primaryKey, SchemaInfo<? extends PersistentData> referenceSchema, 
            boolean json) {
    //@formatter:on
		SchemaColumn c = new SchemaColumn();
		c.schema = (SchemaInfo<? extends PersistentData>) this;
